...
&&     \ket{\psi_1} &= \frac{1}{2\sqrt{2}}(\ket{0} + \ket{1})(\ket{0} + \ket{1})(\ket{0} - \ket{1}) = \frac{1}{2\sqrt{2}}(\ket{00} + \ket{01} + \ket{10} + \ket{11})(\ket{0} - \ket{1}) \\
                  &&&= \frac{1}{2\sqrt{2}}(\ket{000} - \ket{001} + \ket{010} - \ket{011} + \ket{100} - \ket{101} + \ket{110} - \ket{111}) \\ \\
&t_2:& \ket{\psi_2} &= f_{12\rightarrow3}\ket{\psi_1} \\
&&     \ket{\psi_2} &= \frac{1}{2\sqrt{2}}(f\ket{001} - f\ket{001} + f\ket{010} - f\ket{011} + f\ket{100} - f\ket{101} + f\ket{110} - f\ket{111}) \\
...
\begin{align*}
&t_5:&  \ket{\psi_3} &= \frac{1}{4\sqrt{2}}\left(
    \begin{aligned}
...
&&     \ket{\psi_4} &= (\ket{0} + \ket{1})(\ket{0} + \ket{1})(\ket{0} - \ket{1}) = \ket{++-} \\ \\
...
\subsection*{2)}
\begin{flushleft}
    Étant donné $\ket{\psi_5} = \ket{00-}$, on peut déduire que : \\
\end{flushleft}
\begin{align*}
    prob(x_0 = 0) = 1^2 \ket{0} = 100\% \\
    prob(x_1 = 0) = 1^2 \ket{0} = 100\% \\
\end{align*}

\begin{flushleft}
    Donc, la probabilité que $x = x_1x_0$ est : \\
\end{flushleft}
    \begin{align*} prob(x_1)\cdot prob(x_0) = 1 * 1 = 100\% \end{align*}
\\ \\
\section*{Question 3}
\subsection*{1)}
...
\end{flushleft}
\begin{align*}
    prob(\hat{z} = 1) = 1^2 \ket{1} = 100\% \\
    prob(\hat{x} = 1) = 1^2 \ket{1} = 100\% \\
\end{align*}
\begin{flushleft}
...
&t_4:&  \ket{\psi_4} &= Z_{1\rightarrow3}\ket{\psi_3} \\
&&      \ket{\psi_4} &= \frac{1}{\sqrt{2}}((-1)^{z \wedge x}\ket{zxx0} + (-1)^{z \wedge x}\ket{zx\overline{x}1}) \\ \\
